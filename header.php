            ...
            <div class="side-info-content">
                ...
                <div class="contact-infos mb-30">
                    <div class="contact-list mb-30">
                        <h4>Contact Info</h4>
                        <ul>
                            <li><img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon/sidebar-icon-1.png" class="img-fluid" alt="icon-img">86 broklyn street road, New York</li>
                            <li><img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon/footer-icon-1.png" class="img-fluid" alt="icon-img"><a href="mailto:info@sycho24.com">needhelp@company.com</a></li>
                            <li><img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon/footer-icon-2.png" class="img-fluid" alt="icon-img"><a href="tel:926668880000">92 666 888 0000</a></li>
                        </ul>
