                ...
                <div class="row">
                    <div class="col-xxl-12">
                        <div class="project-big-thumb">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/project/project-big-img.jpg" alt="">
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6" data-aos="flip-left" data-aos-duration="1000">
                        <div class="kproject kproject-2 mb-30">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/project/project-img-5.jpg" class="img-fluid" alt="project_img">
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="flip-up" data-aos-duration="1000">
                        <div class="kproject kproject-2 mb-30">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/project/project-img-6.jpg" class="img-fluid" alt="project_img">
                            <div class="kproject-text kproject-text-2">
                                <div class="kproject-text-content">
                                    <span>Design</span>
                                    <h5 class="kproject-text-title"><a href="project-details.html">Fimlor Experience</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="flip-right" data-aos-duration="1000">
                        <div class="kproject kproject-2 mb-30">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/project/project-img-7.jpg" class="img-fluid" alt="project_img">
                            <div class="kproject-text kproject-text-2">
                                <div class="kproject-text-content">
